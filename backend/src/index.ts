...
import childPermissionsRoutes from './routes/child-permissions';
import sessionBlocksRoutes from './routes/session-blocks';
import sessionTemplatesRoutes from './routes/session-templates';
...
import tfcRoutes from './routes/tfc-simple';
...
import masterReportsRoutes from './routes/masterReports';
